...
public class NearestAddictCallingActivity extends AppCompatActivity {
    ...
    int userId = 1;
    String oldNearestUserIdsJsonStr = "";
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        setContentView(R.layout.activity_nearest_addict_calling);
        ...
        getNearestMember(String.valueOf(Commons.thisUser.getIdx()));
    }
    ...
    public void findMore(View view){
        status.setText("Searching ...");
        getAnotherNearestMember(String.valueOf(Commons.thisUser.getIdx()));
    }
    ...
    public void getNearestMember(String memberId) {

        String url = ReqConst.SERVER_URL + "getNearestMember";
...
//                initCall(callCode);
                ...
                status.setText("You don't have any nearest member around you for call.");
            }
            else {
                showToast("Server issue");
            }
    ...
    public void getAnotherNearestMember(String memberId) {

        String url = ReqConst.SERVER_URL + "getAnotherNearestMember";
        progressBar.setVisibility(View.VISIBLE);
        ...
        StringRequest post = new StringRequest(com.android.volley.Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("member_id", memberId);
                try {
                    params.put("oldNearestMemberIds", createOldNearestUserIdsJsonString());
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                return params;
...
//                initCall(callCode);
    ...
    public String createOldNearestUserIdsJsonString()throws JSONException {

        oldNearestUserIdsJsonStr = "";
        ...
        if (oldMemberIds.size()>0){
            for(int i=0; i<oldMemberIds.size(); i++){
                ...
                try {
                    jsonObj.put("old_nearest_member_id", String.valueOf(oldMemberIds.get(i)));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            questionnaireObj.put("oldNearestMemberIds", jsonArr);
            oldNearestUserIdsJsonStr = questionnaireObj.toString();
            return oldNearestUserIdsJsonStr;
        }
        return oldNearestUserIdsJsonStr;
    }
