...
public class MyStoryActivity extends AppCompatActivity implements SwipyRefreshLayout.OnRefreshListener {
...
//        getTestData();
    ...
    private void getTestData(){
        for(int i=0; i<20; i++){
            ...
            story.setDateTime("8/19/2018 3:29 AM");
            ...
            story.setUrl("https://soundcloud.com/audio-files/urban-coyotes-bring-out-the-wild-in-new-york");
            story.setThumbnail("");
            stories.add(story);
        }
